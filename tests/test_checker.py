...
from checker.models import CheckerIssue, CheckerOutput
from checker.tools import find_modified_files, read_file, read_original_file, list_sandbox
...
def test_create_checker_agent():
    from checker.agent import create_checker_agent
